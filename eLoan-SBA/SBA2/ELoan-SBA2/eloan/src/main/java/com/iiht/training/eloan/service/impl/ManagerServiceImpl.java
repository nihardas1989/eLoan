...
public class ManagerServiceImpl implements ManagerService {
	...
	private SanctionOutputDto convertSanctionInfoEntityToSanctionOutputDto(SanctionInfo sanctionInfo) {
	...
	private SanctionInfo covertSanctionDtoToSanctionInfoEntity(SanctionDto sanctionDto, Long managerId, Long loanAppId) {
		...
		termPayment = (sanctionDto.getLoanAmountSanctioned())*(Math.pow((1+(interestRate/100)), sanctionDto.getTermOfLoan()));
		...
		SanctionInfo sanctionInfo = new SanctionInfo(loanAppId, managerId, sanctionDto.getLoanAmountSanctioned(), 
				sanctionDto.getTermOfLoan(),
				sanctionDto.getPaymentStartDate(), loanClosureDate.toString(), monthlyPayment);
		return sanctionInfo;
	}
	...
	private ProcessingDto fetchProcessingDTO(Long loanAppId) {
		...
		ProcessingDto processingDto = this.convertProcessingEntityToProcessingDto(processingInfo);
	...
	private SanctionOutputDto fetchSanctionOutputDto(Long loanAppId) {
		...
		SanctionOutputDto sanctionOutputDto = this.convertSanctionInfoEntityToSanctionOutputDto(sanctionInfo);
		return sanctionOutputDto;
	}
	...
	public SanctionOutputDto sanctionLoan(Long managerId, Long loanAppId, SanctionDto sanctionDto) {
		...
		SanctionOutputDto sanctionOutputDto = this.convertSanctionInfoEntityToSanctionOutputDto(newSanctionInfo);
		return sanctionOutputDto;
	}
